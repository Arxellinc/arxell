...
pub const SUPPORTED_FORMULA_FUNCTION_SPECS: &[FormulaFunctionSpec] = &[
    ...
    FormulaFunctionSpec {
        name: "AI",
        signature: "AI(prompt, [range])",
        description: "Generate text with the selected AI model",
    },
    FormulaFunctionSpec {
        name: "AND",
    ...
    FormulaFunctionSpec {
        ...
        description: "Average values matching a criterion",
    },
    FormulaFunctionSpec {
        name: "CONCAT",
    ...
    FormulaFunctionSpec {
        ...
        description: "Count values matching a criterion",
    },
    FormulaFunctionSpec {
        name: "DATE",
        signature: "DATE(year, month, day)",
        description: "Create a date serial value",
    },
    FormulaFunctionSpec {
        name: "DAY",
        signature: "DAY(date)",
    ...
    FormulaFunctionSpec {
        name: "FIND",
        signature: "FIND(search_for, text_to_search, [starting_at])",
        description: "Find text position",
    },
    FormulaFunctionSpec {
        name: "HOUR",
        signature: "HOUR(time)",
        description: "Hour from a date or time",
    },
    FormulaFunctionSpec {
        name: "IF",
    ...
    FormulaFunctionSpec {
        ...
        description: "Fallback when a formula errors",
    },
    FormulaFunctionSpec {
        name: "INT",
        signature: "INT(value)",
    ...
    FormulaFunctionSpec {
        ...
        description: "True if expression errors",
    },
    FormulaFunctionSpec {
        name: "ISNUMBER",
        signature: "ISNUMBER(value)",
        description: "True if value is numeric",
    },
    FormulaFunctionSpec {
        name: "ISTEXT",
    ...
    FormulaFunctionSpec {
        name: "LEFT",
        signature: "LEFT(text, [number_of_characters])",
        description: "Characters from the left",
    },
    FormulaFunctionSpec {
        name: "LEN",
        signature: "LEN(text)",
    ...
    FormulaFunctionSpec {
        name: "MID",
        signature: "MID(text, starting_at, extract_length)",
        description: "Characters from the middle",
    },
    FormulaFunctionSpec {
        name: "MIN",
    ...
    FormulaFunctionSpec {
        ...
        description: "Minute from a date or time",
    },
    FormulaFunctionSpec {
        name: "MOD",
    ...
    FormulaFunctionSpec {
        ...
        description: "Title-case text",
    },
    FormulaFunctionSpec {
        name: "REPLACE",
        signature: "REPLACE(text, position, length, new_text)",
        description: "Replace text by position",
    },
    FormulaFunctionSpec {
        name: "RIGHT",
        signature: "RIGHT(text, [number_of_characters])",
        description: "Characters from the right",
    },
    FormulaFunctionSpec {
        name: "ROUND",
    ...
    FormulaFunctionSpec {
        ...
        description: "Second from a date or time",
    },
    FormulaFunctionSpec {
        name: "SQRT",
    ...
    FormulaFunctionSpec {
        name: "SUBSTITUTE",
        signature: "SUBSTITUTE(text, search_for, replace_with, [occurrence])",
        description: "Replace matching text",
    },
    FormulaFunctionSpec {
        name: "SUM",
    ...
    FormulaFunctionSpec {
        ...
        description: "Sum values matching a criterion",
    },
    FormulaFunctionSpec {
        name: "TEXT",
    ...
    FormulaFunctionSpec {
        name: "TRIM",
        signature: "TRIM(text)",
        description: "Trim repeated whitespace",
    },
    FormulaFunctionSpec {
        name: "UPPER",
    ...
    FormulaFunctionSpec {
        ...
        description: "Parse text into a number",
    },
    FormulaFunctionSpec {
        name: "YEAR",
        signature: "YEAR(date)",
