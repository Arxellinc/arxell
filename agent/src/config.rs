...
pub const AGENT_HOME_ENV: &str = "ARX_AGENT_HOME";
pub const DEFAULT_CONFIG_DIR_NAME: &str = ".arx_agent";
pub const LOCAL_SKILLS_DIR_ENV: &str = "ARX_AGENT_LOCAL_SKILLS_DIR";
pub const DEFAULT_LOCAL_SKILLS_DIR: &str = ".arx/skills";
pub const LEGACY_LOCAL_SKILLS_DIR: &str = ".kon/skills";
...
impl Config {
    ...
    pub fn config_dir() -> PathBuf {
        ...
        dirs_home().join(DEFAULT_CONFIG_DIR_NAME)
    }
