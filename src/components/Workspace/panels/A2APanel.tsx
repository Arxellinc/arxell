...
import { useA2AExecutionStore } from "../../../store/a2aExecutionStore";
import { useA2AWorkflowStore } from "../../../store/a2aWorkflowStore";
    ...
    const timer = window.setTimeout(() => {
      void (async () => {
        try {
          ...
          const latest = useA2AWorkflowStore.getState();
          if (
                      ...
                      return (
                        <button
                          ...
                          style={{
                            ...
                            top: `${relY}%`,
                            transform,
                            borderColor: count > 0 ? connectedColor : undefined,
                          }}
