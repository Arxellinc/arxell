...
export function selectWorkspaceViewState(args: {
  ...
  return {
    ...
    ...selectFilesToolState(state as any),
    ...selectNotepadToolState(state as any),
    sheetsState: state.sheetsState,
    ...selectDocsToolState(state as any),
    ...selectMemoryToolState(state as any),
    ...selectTasksToolState(state as any),
    chatModelOptions: state.chatModelOptions,
    projectsById: state.projectsById,
    ...selectFlowToolState(state as any),
...
export function selectPrimaryPanelState(state: AnyState, chat: unknown): Record<string, unknown> {
  return {
    ...
    llamaRuntimeLatestVersion: state.llamaRuntimeLatestVersion,
    llamaRuntimeHasUpdate: state.llamaRuntimeHasUpdate,
